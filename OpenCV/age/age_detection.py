...
FACE_PROTO = "weight_age/deploy.prototxt.txt"
...
FACE_MODEL = "weight_age/res10_300x300_ssd_iter_140000_fp16.caffemodel"
...
def predict_age(input_path: str):
    ...
    for i, (start_x, start_y, end_x, end_y) in enumerate(faces):
        ...
        cv2.putText(frame, label, (start_x, end_y+15),
